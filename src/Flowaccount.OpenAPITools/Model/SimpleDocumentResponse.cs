...
namespace Flowaccount.OpenAPITools.Model
{
    ...
    public partial class SimpleDocumentResponse : DocumentResponse,  IEquatable<SimpleDocumentResponse>, IValidatableObject
    {
        ...
        public SimpleDocumentResponse(SimpleDocument data = default(SimpleDocument), bool status = default(bool), string message = default(string), int code = default(int), string documentStructureType = default(string)) : base(status, message, code, documentStructureType)
        {
            this.Data = data;
        }
