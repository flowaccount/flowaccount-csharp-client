...
namespace Flowaccount.OpenAPITools.Model
{
    ...
    public partial class SendEmail :  IEquatable<SendEmail>, IValidatableObject
    {
        ...
        /// <param name="fromemail">ใส่อีเมลผู้ส่ง (required).</param>
        /// <param name="toemail">ใส่อีเมลผู้รับ (required).</param>
        /// <param name="cCMyself">ส่งสำเนาหาตนเอง (default to true).</param>
        /// <param name="ccEmail">สำเนา (CC).</param>
        /// <param name="bccEmail">สำเนาลับ (BCC).</param>
